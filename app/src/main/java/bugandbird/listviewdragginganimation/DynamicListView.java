...
package bugandbird.listviewdragginganimation;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                //Other Android
                mobileView.setVisibility(View.VISIBLE);  // VISIBLE needs to be set INVISIBLE
                switchView.setVisibility(View.INVISIBLE); // remove this line
